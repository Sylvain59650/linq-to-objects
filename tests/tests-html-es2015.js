...
console.log("orderBy", users3.orderBy(function (x) {
  return x.name;
}));

console.log("orderBy", users3.orderBy("age"));

var d = users3.groupBy(function (x) {
  return x.age;
});
...
var longestName = fruits.aggregate(function (longest, next) {
...
var res = users3.aggregate(0, function (a, b) {
  return a + b.age;
});
...
console.log(ints.aggregate(0, function (a, b) {
  return a + b;
}));

console.log("sum", ints.sum());
console.log("sum", users3.sum(function (x) {
  return x.age;
}));

console.log("average", users3.average(function (x) {
  return x.age;
}));
console.log("min", users3.min(function (x) {
  return x.age;
}));
...
console.log(fruits.count(function (x) {
  return x.includes("n");
}));
...
console.log(names.firstOrDefault(function (name) {
...
console.log(numbers.first(function (number) {
  return number > 80;
}));
try {
  console.log(numbers.first(function (number) {
...
console.log(numbers.last(function (number) {
  return number > 80;
}));
try {
  console.log(numbers.last(function (number) {
...
console.log(numbers.min(function (number) {
  return number;
}));

console.log([].max(function (x) {
  return x;
}, 50));
...
console.log("findIndex", store2.findIndex(function (x) {
  return x.Code === 12;
}));
...
console.log("findIndex", [2, 3, 4, 5, 1, 5, 8].findIndex(function (x) {
  return x == 1;
}));

console.log("findLast", [2, 3, 4, 5, 1, 5, 8].findLast(function (x) {
  return x == 5;
}));
...
console.log("findLast", users.findLast(function (x) {
  return x.age < 36;
}));
console.log("find", users.find(function (x) {
  return x.age < 36;
}));

console.log("findLast", [1, 2, 3, 4].findLast(function (n) {
  return n % 2 == 1;
}));
...
var users4 = users.takeWhile(function (o) {
  return !o.active;
});
